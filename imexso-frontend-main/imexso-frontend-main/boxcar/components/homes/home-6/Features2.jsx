    ...
    <section className="why-choose-us-section v2 pt-0">
      <div className="boxcar-container">
        <div className="boxcar-title text-center wow fadeInUp">
          <h2 className="title">Shop, Finance and Buy Your Car</h2>
        </div>
        <div className="row">
          {/* choose-us-block */}
          <div className="choose-us-block col-lg-6 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp">
              ...
              <div className="content-box">
                <h6 className="title">New Specials</h6>
                <div className="text">
          ...
          <div className="choose-us-block col-lg-6 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp" data-wow-delay="100ms">
              ...
              <div className="content-box">
                <h6 className="title">Used Specials</h6>
                <div className="text">
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa
                  qui officia deserunt mollit anim id es. Lorem ipsum dolor sit
                  amet.
          ...
          <div className="choose-us-block col-lg-6 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp" data-wow-delay="200ms">
              ...
              <div className="content-box">
                <h6 className="title">Schedule Service</h6>
                <div className="text">
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa
                  qui officia deserunt mollit anim id es. Lorem ipsum dolor sit
                  amet.
          ...
          <div className="choose-us-block col-lg-6 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp" data-wow-delay="300ms">
              ...
              <div className="content-box">
                <h6 className="title">Value Trade</h6>
                <div className="text">
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa
                  qui officia deserunt mollit anim id es. Lorem ipsum dolor sit
                  amet.
