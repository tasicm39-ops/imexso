      ...
      <div className="large-container">
        <div className="right-box">
          <div className="boxcar-title text-center wow fadeInUp">
            <h2 className="title">{t("features.why_choose_us")}</h2>
          </div>
          <div className="row">
            {/* choose-us-block */}
            <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp">
                ...
                <div className="content-box">
                  <h6 className="title">{t("features.special_financing")}</h6>
                  <div className="text">
                    {t("features.special_financing_desc")}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-delay="100ms">
                ...
                <div className="content-box">
                  <h6 className="title">{t("features.trusted_dealer")}</h6>
                  <div className="text">
                    {t("features.trusted_dealer_desc")}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-delay="200ms">
                ...
                <div className="content-box">
                  <h6 className="title">{t("features.transparent_pricing")}</h6>
                  <div className="text">
                    {t("features.transparent_pricing_desc")}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="choose-us-block col-lg-3 col-md-6 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-delay="300ms">
                ...
                <div className="content-box">
                  <h6 className="title">{t("features.expert_service")}</h6>
                  <div className="text">
                    {t("features.expert_service_desc")}
                  </div>
                </div>
              </div>
            </div>
