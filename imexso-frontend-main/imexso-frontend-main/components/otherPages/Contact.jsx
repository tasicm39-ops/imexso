            ...
            <div className="boxcar-container">
                ...
                <div className="map-sec">
                    <div className="goole-iframe">
                        <iframe
                            src="https://maps.google.com/maps?width=100%25&height=600&hl=en&q=Brussels,%20Belgium+(Imexso)&t=&z=12&ie=UTF8&iwloc=B&output=embed"
                            title="Imexso Location"
                        />
                    </div>
                </div>
                    ...
                    <div className="right-box">
                        <div className="row">
                            ...
                            <div className="contact-column col-lg-6 col-md-12 col-sm-12">
                                <div className="inner-column">
                                    <div className="boxcar-title">
                                        <h6 className="title">{t("contact.contact_details")}</h6>
                                        <div className="text">
                                            {t("contact.contact_details_desc")}
                                        </div>
                                    </div>
                                    ...
                                    <div className="content-box">
                                        ...
                                        <div className="text">contact@imexso.com</div>
                                    </div>
                                    <div className="content-box">
                                        <h6 className="title">
                                            <span className="icon">
                                        ...
                                        <div className="text">+32 000 000 000</div>
                                    </div>
                                    <div className="social-icons">
                                        <h6 className="title">{t("contact.follow_us")}</h6>
